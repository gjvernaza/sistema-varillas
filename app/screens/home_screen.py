        ...
        content=ft.Container(
            ft.Column(
                [
                    ...
                    ft.Text(value="El lote puede que tenga menos de 10 varillas. Por favor, verifique.",
                            style=ft.TextStyle(size=20, weight=ft.FontWeight.BOLD), text_align=ft.TextAlign.CENTER),
                ],
                tight=True,
            ),
            padding=10,
            ...
            ft.Column(
                ...
                controls=[
                    ...
                    ft.Row(
                        ...
                        controls=[
                            ft.ElevatedButton(
                                "Cargar imagen", on_click=lambda _: file_picker.pick_files(allow_multiple=False,
